...
<head>
    <meta charset="UTF-8">
    <title>CRM | Towse Pesthe Shargh</title>
    <meta charset="UTF-8">
    <meta name="description" content="CRM">
    <meta name="keywords" content="CRM, Towse Pesthe Shargh">
    <meta name="author" content="Towse Pesteh Shargh">
    <meta name="app_url" content="{{ url(('/')) }}">
    {{ add_css_file('desktop') }}
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="{{asset('themes/errors-style-js/style-404.css')}}">
                        ...
                        <v-row>
                            <v-col>
                                <div class="error-404-box">
                                    ...
                                    <v-alert type="warning" text border="left" class="text-center">                                    برای بازگشت به صفحه اصلی کلیک کنید!</v-alert>
                                </div>
                            </v-col>
                        </v-row>
                    </v-container>
...
<script  src="{{asset('themes/errors-style-js/script-404.js')}}"></script>
</body>
</html>
